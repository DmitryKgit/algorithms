...
var i=1;
for (; (i < arrNumber.length) && (arrNumber[i-1]*arrNumber[i] <= 0); i++) ;
if(i<arrNumber.length) console.log(arrNumber[i-1], arrNumber[i]);   // пара элементов с одинаковым знаком найдена
