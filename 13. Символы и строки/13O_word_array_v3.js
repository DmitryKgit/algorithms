...
Работает с последовательностями разделяемыми не буквами.
Пользуется регулярными выражениями, с ключом u (unicode metadata).
*/

// Принимает входные данные задачи, возвращает ответ. 
function LongestWord(str) {
    let pos = 0;
    let newAr = str.split(/[^\p{Letter}]/gu); // Разделение НЕ по слову, состоящему из букв.
